...
#include "storage/network/request_facade.cpp"
#include "storage/network/response_facade.cpp"
...
TEST(SendMessage, GetCommand) {
  ...
  {
    RequestFacade req(std::make_shared<Request>());
    std::string message = req.Serialize(Request::Method::Request_Method_Get, "Hello");
